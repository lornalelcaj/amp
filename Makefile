...
QUEUE_OBJECTS = queue_seq.o queue_seq_lock_global_FL.o queue_split_lock_global_FL.o queue_lock_free_local_FL.o thread_stats_tls.o queue_seq_lock_registry_FL.o
